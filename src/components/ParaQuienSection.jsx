...
export default function ParaQuienSection() {
  return (
    <section id="comunidad" className="bg-ink px-6 md:px-16 py-[120px]">
      <span className="block text-[11px] tracking-[3px] uppercase text-olive-wood-700 mb-4">
        04 — Para quién
      </span>
      <h2 className="text-[clamp(28px,3vw,40px)] font-black tracking-[-1.5px] leading-[1.1] text-bg mb-3">
        ¿Sos de los que<br />construyen?
      </h2>
      <p className="text-[15px] text-olive-wood-300 leading-[1.7] mb-14">
          ...
          <div
            ...
            className={[
              ...
              featured
                ...
                : 'bg-[#241808] border-[#2e1d0a]',
            ].join(' ')}
          >
            <span className={[
              'block text-[10px] font-bold tracking-[2.5px] uppercase mb-5',
              featured ? 'text-white/70' : 'text-olive-wood-500',
            ].join(' ')}>
              {label}
            </span>
            <h3 className={[
              'text-[22px] font-black tracking-[-0.5px] mb-3',
            ...
            <p className={[
              ...
              featured ? 'text-white/80' : 'text-olive-wood-600',
            ].join(' ')}>
              {body}
            </p>
            <a href="#sumate"
              className={[
                'inline-block mt-6 text-[12px] font-semibold border rounded-full px-4 py-1.5 no-underline self-start',
                featured ? 'text-white border-white/40' : 'text-soft-apricot-500 border-[#2e1d0a]',
              ].join(' ')}>
              {cta}
            </a>
          </div>
